...
quiz.question{6}.str='f) Qual a tensão Coletor-Emissor Vce?';
quiz.question{6}.units={'V'};
quiz.question{6}.options={'q1:Vce'}; % Device:Var
quiz.question{6}.vartype={'log'}; % From log file
