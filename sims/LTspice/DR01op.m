...
% Generate question
quiz.enunciado = ['Altere os parâmetros do circuito apresentado na Figura 1 e determine:' ]; % Enunciado da pergunta!
...
quiz.question{3}.opttol=[1]; % tolerance in percentage %
...
quiz.question{4}.opttol=[1]; % tolerance in percentage %
