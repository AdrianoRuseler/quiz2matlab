...
% Simulation setup 
circuit.name = 'tbjcc06'; % File name
...
% 
quiz.question{3}.str='c) Qual o valor da tensão no emissor do transistor PNP?';
quiz.question{3}.units={'V'};
quiz.question{3}.options={'Ve'};
...
% % 
quiz.question{4}.str='d) Qual o valor da tensão no coletor do transistor NPN?';
