...
circuit.parnamesim={'Vcc','Ra','Rb','Re','Beta1','Veb','Vecsat','Beta2','Vbe','Vcesat'}; % Variables names simulation
circuit.parname={'Vcc','Ra','Rb','Re','&beta;1','Veb','Vecsat','&beta;2','Vbe','Vcesat'}; % Variables names quiz
circuit.parunit={'V','&Omega;','&Omega;','&Omega;','','V','V','','V','V'}; % Variables unit

% Simulation setup 
circuit.name = 'tbjcc10'; % File name
...
circuit.Xi=CombVec(Vcc,Ra,Rb,Re,Beta1,Veb,Vecsat,Beta2,Vbe,Vcesat); %%
...
% % 
quiz.question{3}.str='c) Qual o valor da corrente nos emissores?';
...
% % % 
% quiz.question{4}.str='d) Qual o valor da tensão no coletor do transistor PNP?';
% quiz.question{4}.units={'V'};
% quiz.question{4}.options={'Vc1'};
