...
circuit.parnamesim={'Vcc','Ra','Rb','Rc','Re','Beta','Vbe','Vcesat','Vz'}; % Variables names simulation
circuit.parname={'Vcc','Ra','Rb','Rc','Re','&beta;','Vbe','Vcesat','Vz'}; % Variables names quiz
...
circuit.Xi=CombVec(Vcc,Ra,Rb,Rc,Re,Beta,Vbe,Vcesat,Vz); %%

% Generate question
quiz.enunciado = ['Para o circuito contendo um transistor NPN e um diodo zener apresentado na Figura 1, determine:' ]; % Enunciado da pergunta!

quiz.question{1}.str='a) Qual o valor da corrente de base?';
quiz.question{1}.units={'A'};
quiz.question{1}.options={'Ib'};
...
% 
quiz.question{4}.str='d) Qual o valor da tensão na base?';
quiz.question{4}.units={'V'};
quiz.question{4}.options={'Vb'};
