...
% Simulation setup 
circuit.name = 'tbjcc08'; % File name
...
quiz.question{1}.str='a) Qual o valor da corrente de base nos transistores?';
...
% % 
% quiz.question{3}.str='c) Qual o valor da tensão no coletor do transistor NPN?';
% quiz.question{3}.units={'V'};
% quiz.question{3}.options={'Vc2'};
