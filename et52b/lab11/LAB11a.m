...
% Config simulation
circuit.parnamesim={'Vdd','Rd'}; % Variables names
circuit.parname={'Vdd','Rd'}; % Variables names
...
c=4; % Coluna
quiz.table{t,c}.header = 'Vds (medido)';
quiz.table{t,c}.units='V';
quiz.table{t,c}.options='m1:Vds';
...
c=5; % Coluna
quiz.table{t,c}.header = 'Vds (escala)';
quiz.table{t,c}.units='V';
quiz.table{t,c}.options='m1:Vds';
quiz.table{t,c}.vartype='log'; % Single only
quiz.table{t,c}.optscore=100; % Score per option
