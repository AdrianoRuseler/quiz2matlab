...
circuit.name = 'lab11a2'; % File name
...
circuit.stepvalues = [1 1.5 2 2.5 5 10 15];

Rd = combres(1,100,'E12'); % 12 resistores

%Rb = combres(1,1000,'E12'); % 12 resistores
Rg = combres(1,10,'E12'); % 12 resistores
circuit.X=CombVec(Rd,Rg);
...
c=2; % Coluna
quiz.table{t,c}.header = 'Vgs (medido)';
quiz.table{t,c}.units='V';
quiz.table{t,c}.options='Vgs';
...
c=3; % Coluna
quiz.table{t,c}.header = 'Vgs (escala)';
quiz.table{t,c}.units='V';
quiz.table{t,c}.options='Vgs';
quiz.table{t,c}.vartype='op'; % Single only
quiz.table{t,c}.optscore=100; % Score per option
...
c=4; % Coluna
quiz.table{t,c}.header = 'VRg (medido)';
quiz.table{t,c}.units='V';
quiz.table{t,c}.options='vrg';
...
c=5; % Coluna
quiz.table{t,c}.header = 'VRg (escala)';
quiz.table{t,c}.units='V';
quiz.table{t,c}.options='vrg';
quiz.table{t,c}.vartype='meas'; % Single only
quiz.table{t,c}.optscore=100; % Score per option
...
c=3;
quiz.table{t,c}.header = 'Ig (calculado)';
quiz.table{t,c}.units='A';
quiz.table{t,c}.options='IRg';
quiz.table{t,c}.vartype='op'; % Single only
quiz.table{t,c}.optscore=100; % Score per option
quiz.table{t,c}.opttol=20; % tolerance in percentage %
quiz.table{t,c}.weight='1'; % Item weight
